...
export interface Check {
   ...
   *
   * LOCAL PATCH (not upstream at v0.47.8.0). A check that bails early —
...
export interface DoctorReport {
  ...
  /**
   * LOCAL PATCH (not upstream at v0.47.8.0) — names of checks that reported
...
function outputResults(
  ...
  // LOCAL PATCH (not upstream at v0.47.8.0): checks that returned ok without
